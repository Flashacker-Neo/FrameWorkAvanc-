...
export class MissionComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.missionService
      ...
      .subscribe({
        next: (res: HttpResponse<IMission[]>) => {
  ...
  trackId(_index: number, item: IMission): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IMission[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
