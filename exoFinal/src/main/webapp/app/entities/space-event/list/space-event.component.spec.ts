...
describe('SpaceEvent Management Component', () => {
  let comp: SpaceEventComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [SpaceEventComponent],
    })
      .overrideTemplate(SpaceEventComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.spaceEvents[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
