...
import academy.campus.demo3.domain.Job;
import academy.campus.demo3.repository.JobRepository;
...
/**
 * REST controller for managing {@link academy.campus.demo3.domain.Job}.
 */
@RestController
@RequestMapping("/api")
@Transactional
