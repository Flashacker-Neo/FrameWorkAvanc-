...
import academy.campus.demo3.domain.JobHistory;
import academy.campus.demo3.repository.JobHistoryRepository;
import academy.campus.demo3.service.JobHistoryService;
...
/**
 * REST controller for managing {@link academy.campus.demo3.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
